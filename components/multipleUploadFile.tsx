          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                <UploadCloudIcon className="mb-1 h-7 w-7 text-brand-primary" />
          ...
          {value?.map(({ file, progress }, i) => (
            ...
            >
              <div className="flex items-center gap-2 text-gray-500 dark:text-white">
                <FileIcon size="30" className="shrink-0 text-brand-primary" />
                <div className="min-w-0 text-sm">
                  <div className="overflow-hidden overflow-ellipsis whitespace-nowrap text-text-primary">
                    {file.name}
                  </div>
